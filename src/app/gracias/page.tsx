    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-background p-4 sm:p-6">
      ...
      <Card className="w-full max-w-2xl text-center shadow-2xl animate-in fade-in duration-500">
        <CardHeader>
          ...
          <CardTitle className="text-3xl font-headline">¡Gracias por completar el diagnóstico!</CardTitle>
            ...
            {error ? (
              ...
              <div className="bg-primary/10 border border-primary/20 p-6 rounded-lg text-left">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="text-xl font-semibold text-primary">Tu Insight Accionable</h3>
                </div>
